  ...
  const renderNav = () => (
    <aside className="hidden lg:flex lg:w-64 lg:flex-col lg:border-r lg:border-gray-200 lg:bg-white">
      ...
      <div className="px-6 py-4 border-t border-gray-100 text-xs text-gray-400">
        v1 admin preview · Frontend simulation
      </div>
    </aside>
  );
    ...
    <div className="space-y-6 p-4 lg:p-8">
      <section className="rounded-2xl border border-gray-200 bg-white p-6">
        ...
        <dl className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-gray-100 bg-gray-50 px-4 py-3">
            ...
            <dd className="mt-1 text-sm text-gray-700">Browser localStorage (per profile)</dd>
          </div>
          <div className="rounded-xl border border-gray-100 bg-gray-50 px-4 py-3">
      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-6">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          />
          <AdminActionCard
            title="Clear CV records"
            description="Removes uploaded or generated CV entries stored locally."
